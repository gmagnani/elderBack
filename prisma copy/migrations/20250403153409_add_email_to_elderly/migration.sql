...
INSERT INTO "new_Elderly" ("addressId", "cpf", "created", "dateOfBirth", "height", "id", "imc", "name", "phone", "sex", "updated", "userId", "weight") SELECT "addressId", "cpf", "created", "dateOfBirth", "height", "id", "imc", "name", "phone", "sex", "updated", "userId", "weight" FROM "Elderly";
DROP TABLE "Elderly";
